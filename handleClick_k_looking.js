const handleClick_k_looking = function() {
    ...
    if(this.state.teamBatting === 0) {
      ...
      newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'ꓘ';
      ...
      newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'ꓘ';
...
export default handleClick_k_looking;