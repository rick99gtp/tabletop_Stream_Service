const handleClick_pop7 = function() {
    ...
    if(this.state.teamBatting === 0) {
      ...
      newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'P7';
      ...
      newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'P7';
...
export default handleClick_pop7;