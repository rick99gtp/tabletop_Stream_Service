const handleClick_pop2 = function() {
    ...
    if(this.state.teamBatting === 0) {
      ...
      newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'P2';
      ...
      newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'P2';
...
export default handleClick_pop2;