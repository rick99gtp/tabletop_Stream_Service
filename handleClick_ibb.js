const handleClick_ibb = function(result) {
  ...
  if(this.state.teamBatting === 0) {
    ...
    newVArray[this.state.vBatter].cell[this.state.vColumn].firstbasetext = 'IBB';
    ...
    newHArray[this.state.hBatter].cell[this.state.hColumn].firstbasetext = 'IBB';
...
export default handleClick_ibb;