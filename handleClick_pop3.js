const handleClick_pop3 = function() {
    ...
    if(this.state.teamBatting === 0) {
      ...
      newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'P3';
      ...
      newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'P3';
...
export default handleClick_pop3;