const handleClick_k = function() {
        ...
        if(this.state.teamBatting === 0) {
          ...
          newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'K';
          ...
          newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'K';
