const handleClick_hbp = function(result) {
  ...
  if(this.state.teamBatting === 0) {
    ...
    newVArray[this.state.vBatter].cell[this.state.vColumn].firstbasetext = 'HBP';
    ...
    newHArray[this.state.hBatter].cell[this.state.hColumn].firstbasetext = 'HBP';
