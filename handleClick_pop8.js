const handleClick_pop8 = function() {
    ...
    if(this.state.teamBatting === 0) {
      ...
      newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'P8';
      ...
      newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'P8';
...
export default handleClick_pop8;