const handleClick_pop1 = function() {
    ...
    if(this.state.teamBatting === 0) {
      ...
      newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'P1';
      ...
      newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'P1';
...
export default handleClick_pop1;