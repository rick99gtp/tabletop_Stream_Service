const handleClick_pop9 = function() {
    ...
    if(this.state.teamBatting === 0) {
      ...
      newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'P9';
      ...
      newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'P9';
...
export default handleClick_pop9;