const handleClick_pop4 = function() {
    ...
    if(this.state.teamBatting === 0) {
      ...
      newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'P4';
      ...
      newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'P4';
...
export default handleClick_pop4;