const handleClick_pop5 = function() {
    ...
    if(this.state.teamBatting === 0) {
      ...
      newArray[this.state.vBatter].cell[this.state.vColumn].centertext = 'P5';
      ...
      newArray[this.state.hBatter].cell[this.state.hColumn].centertext = 'P5';
...
export default handleClick_pop5;